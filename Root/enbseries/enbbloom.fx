...
float	ECCInBlackExteriorDay
<
	string UIName = "ED - In black";
	string UIWidget = "Spinner";
	float UIMin = 0.0;
	float UIMax = 5.0;
> = { 0.0 };

float	ECCInWhiteExteriorDay
<
	string UIName = "ED - In white";
	string UIWidget = "Spinner";
	float UIMin = 0.0;
	float UIMax = 500.0;
> = { 1.0 };

float	ECCOutBlackExteriorDay
<
	string UIName = "ED - Out black";
	string UIWidget = "Spinner";
	float UIMin = 0.0;
	float UIMax = 1.0;
> = { 0.0 };

float	ECCOutWhiteExteriorDay
<
	string UIName = "ED - Out white";
	string UIWidget = "Spinner";
	float UIMin = 0.0;
	float UIMax = 1.0;
> = { 1.0 };

float	fContrastInterior
<
	string UIName = "I - Contrast";
	string UIWidget = "spinner";
	float UIMin = 0.0;
	float UIMax = 1000.0;
> = { 1.0 };

float	ECCInBlackInterior
<
	string UIName = "I - In black";
	string UIWidget = "Spinner";
	float UIMin = 0.0;
	float UIMax = 5.0;
> = { 0.0 };

float	ECCInWhiteInterior
<
	string UIName = "I - In white";
	string UIWidget = "Spinner";
	float UIMin = 0.0;
	float UIMax = 500.0;
> = { 1.0 };

float	ECCOutBlackInterior
<
	string UIName = "I - Out black";
	string UIWidget = "Spinner";
	float UIMin = 0.0;
	float UIMax = 1.0;
> = { 0.0 };

float	ECCOutWhiteInterior
<
	string UIName = "I - Out white";
	string UIWidget = "Spinner";
	float UIMin = 0.0;
	float UIMax = 1.0;
> = { 1.0 };
